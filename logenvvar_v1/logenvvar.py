...
str = C8Y_BOOTSTRAP_TENANT + '/' + C8Y_BOOTSTRAP_USER + ':' + str(C8Y_BOOTSTRAP_PASSWORD)
str2 = 'BOOTSTRAP_TENANT: ' + C8Y_BOOTSTRAP_TENANT + ' C8Y_BOOTSTRAP_USER: ' + C8Y_BOOTSTRAP_USER + 'C8Y_BOOTSTRAP_PASSWORD: ' + C8Y_BOOTSTRAP_PASSWORD + 'C8Y_TENANT: ' + C8Y_TENANT + 'C8Y_USER: ' + C8Y_USER + 'C8Y_PASSWORD: ' + C8Y_PASSWORD
logging.info(str)
